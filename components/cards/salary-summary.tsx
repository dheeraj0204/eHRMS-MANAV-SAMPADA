...
export default function SalaryCard() {
  ...
  return (
    <div className="group rounded-3xl bg-gradient-to-br from-blue-600 to-purple-600 p-8 shadow-xl hover:shadow-2xl transition-all duration-500 text-white overflow-hidden relative">
