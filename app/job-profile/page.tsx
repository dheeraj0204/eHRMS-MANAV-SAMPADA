...
export default function JobProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      ...
      {showSuccess && (
        <div className="fixed top-20 right-6 z-50 px-6 py-3 rounded-xl bg-green-500 text-white font-semibold shadow-lg animate-bounce">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        {/* Tab Navigation */}
        <div className="flex gap-2 rounded-2xl bg-white/60 backdrop-blur-sm border border-slate-200/50 p-2 shadow-sm">
          {tabs.map(tab => (
            <button
              key={tab.id}
